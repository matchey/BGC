...
function showTotalRevenues(area_id)
{
  ...
  let insert_str = "";
  insert_str += "<table><tr><th></th><th>Score Average</th><th>Total Revenue</th></tr>";

  let total_data = {"Alice":{"ave":210, "revenue":500},
                    "Dave" :{"ave":180, "revenue":100},
                    "Grace":{"ave":170, "revenue":-500},
                    "Bob"  :{"ave":190, "revenue":-100},
                    "Ellen":{"ave":190, "revenue":300},
                    "Heidi":{"ave":163, "revenue":-100},
                    "Carol":{"ave":162, "revenue":-200},
...
function showLastResult()
{
  ...
  let insert_str = "";
  insert_str += "<table><tr><th></th><th>Score</th><th>Revenue</th></tr>";
